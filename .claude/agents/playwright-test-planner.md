...
**Prohibido en el plan:**
- Especificar locators, selectores CSS/XPath o rutas de archivo concretas (eso es responsabilidad del generador + pages/)
- Hardcodear URLs o credenciales en los pasos
- Asumir que el estado persiste entre escenarios (cada test arranca desde cero)

**Idioma:** si la UI está en español, los títulos y pasos del plan van en español.
